  ...
  const data = [
    {
      ...
      description: 'Denka® has been installed in our facilities on 9NOV21 and helped us to save 7.4% of the total consumption. Wonderful!',
      img: img1,
      rating: 4,
    },
    {
      name: "Shanvas PK",
      role: 'GM of ARMCON',
      description: 'I certify and guarantee the proper functioning of the Enersol plates, produced by Techsol® Group, Implemented in our facilities since June 2020 and our electricity consumption has reduced by 17%',
      img: img2,
      rating: 5,
    },
    {
      ...
      description: 'At first I couldn’t believe but since Enersol installation in our facilities last December 2022 we’ve been able to save 14.2% of our electricity bill, Yes, We do recommend Enersol.',
      img: img3,
      rating: 4,
    },
    {
      name: "Juan Camilo",
      role: 'PM Canis Group',
      description: 'The customers’ experience highlighted: the efficiency, reliability, and quality of Denka® technology. And we recommend working with Enersol it is a satisfaction!',
      img: img4,
      rating: 5,
    },
    {
      ...
      description: 'Enersol has been installed in our facilities since Feb, 2019 & we have got an incredible 15% savings.',
      img: img5,
      rating: 4,
    },
    {
      ...
      description: 'our focus has been no the industrial sector, the most demanding of energy consumption, where significant reductions have been found due to savings in electrical energy. Thank you Enersol!',
      img: img6,
      rating: 5,
    },
  ...
  return (
    <>
      <div className="text-black font-raleway md:pb-40 sm:pb-32 pb-8 md:pt-20 pt-10 px-4 bg-gradient-to-b from-[#8A73E8] to-[#FFFF]">
        <h1 className="xl:text-6xl lg:text-5xl md:text-4xl text-3xl font-bold text-center">Testomonial</h1>
        <motion.div
        ...
        >
          <Slider ref={sliderRef} {...sliderSettings} className="relative z-10">
            {
              data.map((e, i) => (
                <div key={i} className=" w-[80%] flex justify-center  flex-col items-center" >
                  <div className="relative flex justify-center py-8 px-2">
                    ...
                    <div className="absolute sm:bottom-4 bottom-6 left-1/2 -translate-x-1/2 border-2 rounded-full border-gray">
                      <Image alt="" src={e.img} className="xl:w-28 lg:w-20 md:w-16 sm:w-12 w-8 rounded-full" />
                    </div>
                  </div>

                  <h1 className="sm:text-2xl text-xl font-extrabold sm:mb-8 mb-3  text-center">{e.role}</h1>
                  <div className="w-full flex justify-center">
                    <div className="md:w-[70%] w-[90%]">
                      <p className="font-medium text-center sm:text-base text-sm">{e.description}</p>
                    </div>
                  </div>
                </div>
              ))
        ...
        > */}
          <div className="lg:w-[70%] w-full py-12 flex flex-col items-center lg:gap-12 sm:gap-10 gap-6" >
            ...
            <h1 className="text-2xl lg:text-5xl leading-snug sm:text-3xl xl:text-[64px]  text-center font-semibold px-4 sm:px-0">
              Launch Your Project <br className="lg:block hidden" />With Us
            </h1>
            ...
            <div className="w-full  flex justify-center gap-4 sm:gap-7 items-center">
              <Link href={'https://www.facebook.com/denka.jp'} className="cursor-pointer bg-gradient-to-r from-[#372DA7] to-[#8A73E8] rounded-full w-[50px] h-[50px] sm:w-[60px] sm:h-[60px] flex justify-center items-center">
                <Image
                  height={10}
                  width={15}
                  alt="facebook"
              ...
              <Link href={'https://www.linkedin.com/company/denkajp'} className="cursor-pointer bg-transparent rounded-full border border-white w-[50px] h-[50px] sm:w-[60px] sm:h-[60px] flex justify-center items-center">
                <Image
                  height={25}
                  width={25}
                  alt="linkedin"
              ...
              <Link href={''} className="cursor-pointer bg-transparent rounded-full border border-white w-[50px] h-[50px] sm:w-[60px] sm:h-[60px] flex justify-center items-center">
                <Image
                  height={25}
                  width={25}
                  alt="twitter"
