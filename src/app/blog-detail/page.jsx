    ...
    return (
        <div>
            ...
            <div className="relative">
                ...
                <div className="sm:pt-[150px] pt-20 text-center  flex flex-col items-center text-black">
                    ...
                    <Image alt='' src={text} className='md:w-[18%]  w-[30%]' />
                </div>
            </div>

            {/* main section */}
            <div className='flex justify-center font-raleway py-20 px-4'>
